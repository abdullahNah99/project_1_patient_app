...
import '../doctor_cubit/states.dart';
...
class ShowConsultingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    itemBuilder: (context, index) => consultItemBuilder(),
...
Widget consultItemBuilder( ) => Padding(
        ...
        Padding(
          ...
          child: Column(
            ...
            [
              ...
              Padding(
                padding:const EdgeInsetsDirectional.only(start: 5.0,top: 10.0,bottom: 10.0),
                child: Container(
                  width:284.w,
                  height:1.h,
