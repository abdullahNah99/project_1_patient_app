...
class DoctorProfileItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => SecretariaLyoutCubit()..viewInfoHandle(id: indexApp),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: state is ViewInfoHandleSuccssesState ? ListView.separated(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Align(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                cubit.viewInfoHandleModel.appointment.doctor.workTimes[index].day,
                                                style: TextStyle(
                                                  color: defaultColor,
                                                  fontSize: 15.w,
                                              ...
                                              Text(
                                                'From: ${cubit.viewInfoHandleModel.appointment.doctor.workTimes[index].startTime}'.replaceRange(11, 14, ''),
                                                style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 14.5.w,
                                                  fontWeight: FontWeight.w400,
                                              ...
                                              Text(
                                                'To:      ${cubit.viewInfoHandleModel.appointment.doctor.workTimes[index].endTime}'.replaceRange(9, 12, ''),
                                                style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 14.5.w,
                                                  fontWeight: FontWeight.w400,
                                  ...
                                  itemCount: cubit.viewInfoHandleModel.appointment.doctor.workTimes.length,
                                )
